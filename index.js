...
const commands = {
  makeDirectories: function(name) { return `mkdir ${name} && mkdir ${name}/public && mkdir ${name}/src && mkdir ${name}/src/components && mkdir ${name}/src/styled-components` },
  copyPackageJSON: function(name) { return `cp files/package.json ${name}/package.json` },
  enterDirectory: function(name) { return `cd ${name}` },
  npmInit: 'npm init -y',
  dependencies: 'npm install --save react react-dom rebass styled-components prop-types',
  ...
  copyFiles: function(name) { return `cp files/index.js ${name}/src/index.js && cp files/index.html ${name}/public/index.html && cp files/components/index.js ${name}/src/components/index.js && cp files/components/title.js ${name}/src/components/title.js && cp files/style-theme.js ${name}/style-theme.js && cp files/styled-components/index.js ${name}/src/styled-components/index.js && cp files/styled-components/button.js ${name}/src/styled-components/button.js` },
